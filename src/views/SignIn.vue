        ...
        <div class="sign-in__fields">
          <div class="sign-in__field">
            <input
              ...
              v-model="email"
            />
            <label class="sign-in__label visually-hidden" for="user-email"
              >Email address</label
            >
          </div>
          <div class="sign-in__field">
            <input
              ...
              v-model="password"
            />
            <label class="sign-in__label visually-hidden" for="user-password"
              >Password</label
            >
          </div>
        </div>
